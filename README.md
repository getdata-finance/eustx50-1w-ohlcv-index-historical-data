...
**EUSTX50 1w OHLCV index historical data** — ultra high-quality 1w OHLCV for **EURO STOXX 50**. Clean `time, open, high, low, close, volume` CSV for backtesting, algorithmic trading and quantitative research.
...
> **Sample on GitHub** · `EUSTX50_1w.csv` (13 rows, `2026-06-04` -> `2026-08-27`, 0.86 KB). **Full archive on [getdata.finance](https://getdata.finance/datasets/eustx50)** — **732** `1w` rows (full `1m`: 2,836,357), **11 timeframes**, `2012-08-23` -> `2026-08-27`.
...
| 1w rows | 13 | **732** |
| Size | 0.86 KB | full ZIP on [getdata.finance](https://getdata.finance/datasets/eustx50) |
...
df = pd.read_csv('EUSTX50_1w.csv', parse_dates=['time'])
